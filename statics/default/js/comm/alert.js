...
$.alerts={
    ...
    ,_canLogin:function(msg,title,type,isLogin){
        ...
        if(isLogin == 2) {
            $("#popup_message").append('<div id="popup_panel"><input type="button" value="返回" id="popup_cancel" /></div>');
        }else{
            $("#popup_message").append('<div id="popup_panel"><input type="button" value="返回" id="popup_cancel" /><a href="javascript:OnLogin();" id="popup_ok" style="line-height: 18px; margin-left: 10px; vertical-align: top;">登录</a></div>');
        }
        $("#popup_cancel").click(function(){
            history.back();
        });
